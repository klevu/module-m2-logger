 ...
 * @covers ClearLogs
 */
class ClearLogsTest extends WebapiAbstract
{
    use FileSystemTrait;

    private const RESOURCE_PATH = '/V1/klevu_logger/clear_logs/store/';
    ...
    public function testErrorReturned_WhenIncorrectHttpMethod(string $method): void
    {
        ...
        $storeId = '1';
        $this->createLogFile('test-archive.tar', '.archive');
    ...
    public function testAclHasAccess(): void
    {
        ...
        $this->assertSame('Logs Cleared for Store Id ' . $storeId, $response['message']);
    }

    public function testErrorReturned_WhenInvalidStoreProvided(): void
    {
        $this->_markTestAsRestOnly();
        ...
        $this->assertArrayHasKey('message', $response);
        $this->assertSame('Store Id ' . $storeId . ' not found.', $response['message']);
    }

    public function testErrorReturned_WhenDirectoryDoesNotExist(): void
    {
        $this->_markTestAsRestOnly();
        $storeId = '1';
        $this->deleteAllLogs();
        ...
        $this->assertSame(
            ...
            'Check logs for store ' . $storeId . ' for more information.',
            $response['message'],
        );
    }
    ...
    public function testClearLogs_ReturnsSuccess(): void
    {
        $this->_markTestAsRestOnly();
        $storeId = '1';
        $this->createLogFile('test-archive.tar', '.archive');
